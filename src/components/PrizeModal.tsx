  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-card border-2 border-primary rounded-2xl casino-shadow max-w-sm w-full max-h-[90vh] overflow-y-auto animate-bounce-in">
        {/* Header */}
        <div className="text-center p-6 bg-gradient-gold rounded-t-2xl">
          <div className="text-4xl mb-3">{prize.emoji}</div>
          <h2 className="text-2xl title-font text-background mb-2">Congratulations! 🎉</h2>
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="space-y-3">
            ...
            {/* Step 1 */}
            <div className="bg-muted/20 rounded-lg p-4 luxury-border">
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <p className="font-semibold mb-2">Sign Up on Gangagames Platform</p>
          ...
          <div className="bg-muted/10 rounded-lg p-4 text-center">
            ...
            <div className="bg-background/20 rounded-full h-3 mb-2">
              <div className="bg-gradient-gold h-full rounded-full w-0 transition-all duration-1000"></div>
            </div>
